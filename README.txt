...
* на него приходит ответ 302 Moved Temporarily на тот же ver.html, но в актуальной директории:

	rewrite ^/_/ver.html$ /__v$ver/ver.html redirect;

* а сама страница, будучи загруженной из директории $ver, устанавливает staticRoot, исходя из собственного URL, после чего вызывает перезагрузку главного окна.
