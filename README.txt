...
* Base64img.measure — анализирует переданное изображение и вызывает callback с вычисленными размерами;
* Base64img.resize — приводит изображение к заданному размеру и выдаёт data URI для новой картинки с заданными параметрами качества.
